...
<html class="no-js">
  <head>
    ...
    <c:if test="${!task.status.finalState}">
    ...
    <div class="wrapper">
      ...
      <article id="main">
          ...
          <section class="summary">
            ...
            <div><b>In queue:</b><c:if test="${task.status.finalState}">${task.result.queueTimeSec}s</c:if></div>
            <div><b>Processing:</b><c:if test="${task.status.finalState}">${task.result.processingTimeSec}s</c:if></div>
