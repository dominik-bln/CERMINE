...
<div id="tabs">
  ...
  <ul>
    ...
    <li><a href="#tabs-nlm">JATS</a></li>
  </ul>

  <div id="tabs-meta">
    <p>Extracted metadata formatted in HTML form. Please see JATS for full extraction results.</p>
    <br/>
  ...
  <div id="tabs-refs">
    <p>Bibliographic references formatted in HTML form. Please see JATS for full extraction result.</p>
    <br/><br/>
    <ol>
  ...
  <div id="tabs-text">
    <p>Full text formatted in HTML form. Please see JATS for full extraction result.</p>
    ${html}
  </div>

  <div id="tabs-nlm">
    <p>Result as a JATS XML record <a href="download.html?type=nlm&task=${task.id}">(download)</a>:</p>
