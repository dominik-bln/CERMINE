...
/**
 * The basis for all exceptions in cermine.
 *
 * @author Dominik Horb <cermine@dominik.berlin>
 *
 */
public class CermineException extends Exception {

    public CermineException() {
        super();
    }

    public CermineException(String message, Throwable cause) {
        super(message, cause);
    }

    public CermineException(String message) {
        super(message);
    }

    public CermineException(Throwable cause) {
        super(cause);
    }
}
