...
/**
 * All field names of the BibTeX format.
 * 
 * @author Dominik Horb <cermina@dominik.berlin>
 */
public enum BibtexField {

    ABSTRACT, ADDRESS, AFFILIATION, ANNOTE, AUTHOR,
    BOOKTITLE,
    CHAPTER, CONTENTS, COPYRIGHT, CROSSREF,
    DOI,
    EDITION, EDITOR,
    HOWPUBLISHED,
    INSTITUTION, ISBN, ISSN, JOURNAL,
    KEY, KEYWORDS,
    LANGUAGE, LCCN, LOCATION,
    MONTH, MRNUMBER,
    NOTE, NUMBER,
    ORGANIZATION,
    PAGES, PUBLISHER,
